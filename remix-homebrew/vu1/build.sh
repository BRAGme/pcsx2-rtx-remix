#!/usr/bin/env bash
# Build remixtest_vu1.elf with the ps2dev toolchain installed under MSYS2 /usr/local/ps2dev.
...
make "$@"
ls -l remixtest_vu1.elf
mips64r5900el-ps2-elf-size remixtest_vu1.elf 2>/dev/null || true
